...
* [`src/hot_load/styles.cljs`](src/hot_load/styles.cljs): CSS compilation source file (ClojureScript,
[Garden](https://github.com/noprompt/garden))
* [`src/hot_load/`](src/hot_load/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/hot_load/core.cljs): contains the SPA entry point, `init`
...
5. Clone this repo and open a terminal in the `hot-load` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/hot_load/config.cljs) defaults to `true` in
...
```clj
(ns hot-load.example
  (:require [hot-load.config :as config])
